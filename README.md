...
<details>
  ...
  * Data para entrega no prazo regular: `11/08/2023 14:00`.
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-027-a-restaurant-orders.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-027-a-restaurant-orders`
  ...
  - Crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-sd-027-a-restaurant-orders`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-027-a-restaurant-orders`

  7. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-027-a-restaurant-orders/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-027-a-restaurant-orders/pulls) e confira que o seu _Pull Request_ está criado
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH27-A&template=betrybe/sd-0x-restaurant-orders)
